-- Rollback: drop public.list_supplier_purchase_orders(uuid, uuid[], integer,
-- integer, text, text, uuid, uuid, text) and redeploy the API to use the
-- previous direct table query. The migration is read-only and does not mutate
-- purchase order or fulfillment facts.
