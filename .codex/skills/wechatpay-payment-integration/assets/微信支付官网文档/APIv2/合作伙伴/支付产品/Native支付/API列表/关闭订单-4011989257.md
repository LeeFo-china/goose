---
url: "https://pay.weixin.qq.com/doc/v2/partner/4011989257.md"
title: "关闭订单"
doc_id: 4011989257
---
...
| 返回信息 | return\_msg | 否 | String(128) | 签名失败 | 返回信息，如非空，为错误原因<br>例如：签名失败、参数格式校验错误 |
...
| 错误代码描述 | err\_code\_des | 否 | String(128) | 系统错误 | 当result\_code为FAIL时返回错误代码，详细参见下文错误列表 |
