---
url: "https://pay.weixin.qq.com/doc/v2/partner/4011941178.md"
title: "申请退款"
doc_id: 4011941178
---
...
服务商模式下，退款接口需要单独申请权限，具体请[点击此处查看](http://kf.qq.com/faq/170606Rnyq2u170606MJZNVB.html)
...
| 退款货币种类 | refund\_fee\_type | 否 | String(8) | CNY | 退款货币类型，需与支付一致，或者不填。符合ISO 4217标准的三位字母代码，默认人民币：CNY，其他值列表详见[货币类型](https://pay.weixin.qq.com/doc/v2/partner/4011941200.md) |
...
| 错误代码 | err\_code | 否 | String(32) | SYSTEMERROR | 列表详见第6节 |
...
| NOAUTH | 异常IP请求不予受理 | 请求ip异常 | 请求退款的IP地址与合作伙伴平台配置的IP地址不一致。<br>解决方法：商户号超管登录[合作伙伴平台](https://pay.weixin.qq.com/partner/public/home)，通过路径「交易中心→退款管理→退款配置→退款IP白名单→开启配置」，进入配置页面后可开启/关闭白名单功能和配置IP地址；动态IP建议关闭IP配置，静态IP检查与配置的IP列表是否一致。 |
