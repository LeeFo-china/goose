---
url: "https://pay.weixin.qq.com/doc/v2/merchant/4011937139.md"
title: "获取用户ip指引"
doc_id: 4011937139
---
...
H5支付要求商户在统一下单接口中上传用户真实ip地址“spbill\_create\_ip”，为保证微信端获取的用户ip地址与商户端获取的一致，提供了以下获取用户ip的指引，希望对大家有所帮助。

## 没有代理的情况

在商户的前端接入层没有做代理的情况下获取ip的方式比较简单，直接获取'REMOTE\_ADDR '即可。
