---
url: "https://pay.weixin.qq.com/doc/brand/4015736398-go.md"
...
func main() {
	...
	request := &UpdateStockBudgetRequest{
		OutRequestNo:    wxpay_brand_utility.String("update_budget_34657_20250101_123456"),
		...
		CurrentMaxCount: wxpay_brand_utility.Int64(10000000),
		TargetMaxCount:  wxpay_brand_utility.Int64(200),
	}
...
func UpdateStockBudget(config *wxpay_brand_utility.BrandConfig, request *UpdateStockBudgetRequest) (response *StockEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/update-budget"
	)
