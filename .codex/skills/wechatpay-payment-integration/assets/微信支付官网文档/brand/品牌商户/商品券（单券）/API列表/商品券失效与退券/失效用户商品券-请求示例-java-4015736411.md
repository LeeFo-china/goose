---
url: "https://pay.weixin.qq.com/doc/brand/4015736411-java.md"
title: "失效用户商品券-请求示例-java"
doc_id: 4015736411
example_lang: "java"
---
 ...
 * 失效用户商品券
 */
public class DeactivateUserProductCoupon {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/brand/4015415289
    DeactivateUserProductCoupon client = new DeactivateUserProductCoupon(
    ...
    DeactivateUserProductCouponRequest request = new DeactivateUserProductCouponRequest();
    ...
    request.outRequestNo = "MCHDEACTIVATE202003101234";
  ...
  public UserProductCouponEntity run(DeactivateUserProductCouponRequest request) {
    String uri = PATH;
  ...
  public DeactivateUserProductCoupon(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
  ...
  public static class DeactivateUserProductCouponRequest {
