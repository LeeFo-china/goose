---
url: "https://pay.weixin.qq.com/doc/brand/4016755503.md"
...
## 1. 单券-全场-折扣券 (SINGLE_ALL_DISCOUNT)
...
curl -X POST \
  ...
  -d '{
    "out_request_no": "SINGLE_ALL_DISCOUNT_20250120_001", # 必填，创建请求单号
    "scope": "ALL", # 必填，优惠范围
    "type": "DISCOUNT", # 必填，券类型
    "usage_mode": "SINGLE", # 必填，使用模式

    "single_usage_info": { # 当usage_mode=SINGLE且scope=ALL时必填，单券模式信息（仅全场券在此设置优惠规则）
      "discount_coupon": { # 当type=DISCOUNT且scope=ALL时必填，折扣券规则
        "threshold": 10000, # 当type=DISCOUNT且scope=ALL时必填，门槛金额，单位：分
        "percent_off": 20 # 当type=DISCOUNT且scope=ALL时必填，折扣百分比
      }
    },

    "display_info": { # 必填，展示信息
      "name": "全场满100立打8折", # 必填，商品券名称
...
public class AllDiscountJava {
  ...
  public static void main(String[] args) {
    ...
    AllDiscountJava client = new AllDiscountJava(
    ...
    request.singleUsageInfo.discountCoupon.threshold = 10000L; // 必填，门槛金额(单位：分)，满100元可用
    request.singleUsageInfo.discountCoupon.percentOff = 20L; // 必填，折扣百分比，20表示打8折
    // 必填，商品券展示信息
    request.displayInfo = new ProductCouponDisplayInfo();
    request.displayInfo.name = "全场满100立打8折"; // 必填，商品券名称，最多12个字符
    ...
    try {
      CreateProductCouponResponse response = client.run(request);
        // TODO: 请求成功，继续业务逻辑
        System.out.println("全场折扣券创建成功: " + response.productCouponId);
  ...
  public AllDiscountJava(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
  ...
  public static class ProductCouponDisplayInfo {
    ...
    /** 条件必填，商品原价(单位：分)。scope=SINGLE时必填 */
    @SerializedName("original_price")
    public Long originalPrice;

    /** 条件必填，套餐组合列表。scope=SINGLE时必填 */
	...
	request := &CreateProductCouponRequest{
		...
		SingleUsageInfo: &SingleUsageInfo{
			...
			DiscountCoupon: &DiscountCouponUsageRule{
				Threshold:  wxpay_brand_utility.Int64(10000), // 必填，门槛金额(单位：分)，满100元可用
				PercentOff: wxpay_brand_utility.Int64(20),    // 必填，折扣百分比，20表示打8折
			},
		},
		// 必填，商品券展示信息
		DisplayInfo: &ProductCouponDisplayInfo{
			Name:          wxpay_brand_utility.String("全场满100立打8折"),                           // 必填，商品券名称，最多12个字符
