---
url: "https://pay.weixin.qq.com/doc/brand/4015736433-go.md"
title: "核销用户商品券-请求示例-go"
doc_id: 4015736433
example_lang: "go"
---
...
func main() {
	...
	request := &UseUserProductCouponRequest{
		...
		UseTime:         wxpay_brand_utility.Time(time.Now()),
		OutRequestNo:    wxpay_brand_utility.String("MCHUSE202003101234"),
		AssociatedOrderInfo: &UserProductCouponAssociatedOrderInfo{
			TransactionId: wxpay_brand_utility.String("4200000000123456789123456789"),
		},
	}
...
func UseUserProductCoupon(config *wxpay_brand_utility.BrandConfig, request *UseUserProductCouponRequest) (response *UserProductCouponEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/use"
	)
