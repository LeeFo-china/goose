---
url: "https://pay.weixin.qq.com/doc/brand/4015736315-go.md"
title: "失效商品券-请求示例-go"
doc_id: 4015736315
example_lang: "go"
---
...
func main() {
	...
	request := &DeactivateProductCouponRequest{
		...
		DeactivateReason: wxpay_brand_utility.String("商品券信息有误，重新创建"),
	}
...
func DeactivateProductCoupon(config *wxpay_brand_utility.BrandConfig, request *DeactivateProductCouponRequest) (response *ProductCouponEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/deactivate"
	)
