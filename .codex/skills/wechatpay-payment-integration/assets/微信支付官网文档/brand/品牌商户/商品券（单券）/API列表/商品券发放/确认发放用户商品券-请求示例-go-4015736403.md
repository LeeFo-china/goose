---
url: "https://pay.weixin.qq.com/doc/brand/4015736403-go.md"
...
func main() {
	...
	request := &ConfirmSendUserProductCouponRequest{
		...
		OutRequestNo:    wxpay_brand_utility.String("MCHCONFIRM202003101234"),
	}
...
func ConfirmSendUserProductCoupon(config *wxpay_brand_utility.BrandConfig, request *ConfirmSendUserProductCouponRequest) (response *UserProductCouponEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/confirm"
	)
