---
url: "https://pay.weixin.qq.com/doc/brand/4016755504.md"
title: "【单券-全场-满减券】API请求示例"
doc_id: 4016755504
---
...
curl -X POST \
  ...
  -d '{
    "out_request_no": "SINGLE_ALL_NORMAL_20250120_002", # 必填，创建请求单号
    "scope": "ALL", # 必填，优惠范围
    "type": "NORMAL", # 必填，券类型
    "usage_mode": "SINGLE", # 必填，使用模式

    "single_usage_info": { # 当usage_mode=SINGLE且scope=ALL时必填，单券模式信息（仅全场券在此设置优惠规则）
      "normal_coupon": { # 当type=NORMAL且scope=ALL时必填，满减券规则
        "threshold": 20000, # 当type=NORMAL且scope=ALL时必填，门槛金额，单位：分
        "discount_amount": 5000 # 当type=NORMAL且scope=ALL时必填，减免金额，单位：分
      }
    },

    "display_info": { # 必填，展示信息
      "name": "全场满200减50", # 必填，商品券名称
...
public class AllNormalJava {
  ...
  public static void main(String[] args) {
    ...
    AllNormalJava client = new AllNormalJava(
    ...
    request.singleUsageInfo.normalCoupon.threshold = 20000L; // 必填，门槛金额(单位：分)，满200元可用
    request.singleUsageInfo.normalCoupon.discountAmount = 5000L; // 必填，固定减免金额(单位：分)，减50元
    // 必填，商品券展示信息
    request.displayInfo = new ProductCouponDisplayInfo();
    request.displayInfo.name = "全场满200减50"; // 必填，商品券名称，最多12个字符
    ...
    try {
      CreateProductCouponResponse response = client.run(request);
        // TODO: 请求成功，继续业务逻辑
        System.out.println("全场满减券创建成功: " + response.productCouponId);
  ...
  public AllNormalJava(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
