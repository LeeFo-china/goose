---
url: "https://pay.weixin.qq.com/doc/brand/4015736352-go.md"
title: "失效商品券批次-请求示例-go"
doc_id: 4015736352
example_lang: "go"
---
...
func main() {
	...
	request := &DeactivateStockRequest{
		OutRequestNo:     wxpay_brand_utility.String("de_34657_20250101_123456"),
		ProductCouponId:  wxpay_brand_utility.String("1000000013"),
		StockId:          wxpay_brand_utility.String("1000000013001"),
		DeactivateReason: wxpay_brand_utility.String("批次信息有误，重新创建"),
	}
...
func DeactivateStock(config *wxpay_brand_utility.BrandConfig, request *DeactivateStockRequest) (response *StockEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/deactivate"
	)
