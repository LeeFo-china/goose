---
url: "https://pay.weixin.qq.com/doc/brand/4015736373-go.md"
...
func GetStock(config *wxpay_brand_utility.BrandConfig, request *GetStockRequest) (response *StockEntity, err error) {
	const (
