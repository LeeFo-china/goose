---
url: "https://pay.weixin.qq.com/doc/brand/4015736390-java.md"
title: "向用户发放商品券-请求示例-java"
doc_id: 4015736390
example_lang: "java"
---
 ...
 * 向用户发放商品券
 */
public class SendUserProductCoupon {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/brand/marketing/product-coupon/users/{openid}/coupons";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/brand/4015415289
    SendUserProductCoupon client = new SendUserProductCoupon(
    ...
    SendUserProductCouponRequest request = new SendUserProductCouponRequest();
    ...
    request.sendRequestNo = "MCHSEND202003101234";
    request.attach = "any attach content";
    request.couponTagInfo = new CouponTagInfo();
    request.couponTagInfo.couponTagList = new ArrayList<>();
    {
      request.couponTagInfo.couponTagList.add(UserProductCouponTag.MEMBER);
    };
    request.couponTagInfo.memberTagInfo = new MemberTagInfo();
    request.couponTagInfo.memberTagInfo.memberCardId = "MemberCardId_1234567890";
    try {
  ...
  public UserProductCouponEntity run(SendUserProductCouponRequest request) {
    String uri = PATH;
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, UserProductCouponEntity.class);
      } else {
  ...
  public SendUserProductCoupon(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
  ...
  public static class SendUserProductCouponRequest {
