---
url: "https://pay.weixin.qq.com/doc/brand/4015736411-go.md"
...
func main() {
	...
	request := &DeactivateUserProductCouponRequest{
		...
		OutRequestNo:     wxpay_brand_utility.String("MCHDEACTIVATE202003101234"),
...
func DeactivateUserProductCoupon(config *wxpay_brand_utility.BrandConfig, request *DeactivateUserProductCouponRequest) (response *UserProductCouponEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate"
	)
