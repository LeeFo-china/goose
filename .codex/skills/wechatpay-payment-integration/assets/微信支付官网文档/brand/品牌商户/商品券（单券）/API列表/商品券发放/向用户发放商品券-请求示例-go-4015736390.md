---
url: "https://pay.weixin.qq.com/doc/brand/4015736390-go.md"
...
func SendUserProductCoupon(config *wxpay_brand_utility.BrandConfig, request *SendUserProductCouponRequest) (response *UserProductCouponEntity, err error) {
	const (
