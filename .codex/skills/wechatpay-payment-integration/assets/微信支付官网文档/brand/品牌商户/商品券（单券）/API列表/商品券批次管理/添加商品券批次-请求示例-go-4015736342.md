---
url: "https://pay.weixin.qq.com/doc/brand/4015736342-go.md"
title: "添加商品券批次-请求示例-go"
doc_id: 4015736342
example_lang: "go"
---
...
func main() {
	...
	response, err := CreateStock(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func CreateStock(config *wxpay_brand_utility.BrandConfig, request *CreateStockRequest) (response *StockEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/stocks"
	)
...
func (o *CreateStockRequest) MarshalJSON() ([]byte, error) {
	type Alias CreateStockRequest
	a := &struct {
		ProductCouponId *string `json:"product_coupon_id,omitempty"`
		*Alias
	}{
