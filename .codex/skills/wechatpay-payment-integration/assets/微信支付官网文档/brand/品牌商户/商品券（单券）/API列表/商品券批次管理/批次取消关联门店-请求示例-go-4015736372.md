---
url: "https://pay.weixin.qq.com/doc/brand/4015736372-go.md"
title: "批次取消关联门店-请求示例-go"
doc_id: 4015736372
example_lang: "go"
---
...
func main() {
	...
	request := &DisassociateStoresRequest{
		ProductCouponId: wxpay_brand_utility.String("1000000013"),
		StockId:         wxpay_brand_utility.String("1000000013001"),
		StoreList: []StoreInfo{
			StoreInfo{
				StoreId: wxpay_brand_utility.String("100000001"),
			},
			StoreInfo{
				StoreId: wxpay_brand_utility.String("100000002"),
			},
			StoreInfo{
				StoreId: wxpay_brand_utility.String("100000003"),
			},
			StoreInfo{
				StoreId: wxpay_brand_utility.String("12"),
			},
		},
	}

	response, err := DisassociateStores(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func DisassociateStores(config *wxpay_brand_utility.BrandConfig, request *DisassociateStoresRequest) (response *DisassociateStoresResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/disassociate-stores"
	)
...
type DisassociateStoresRequest struct {
	ProductCouponId *string     `json:"product_coupon_id,omitempty"`
	StockId         *string     `json:"stock_id,omitempty"`
	StoreList       []StoreInfo `json:"store_list,omitempty"`
}

func (o *DisassociateStoresRequest) MarshalJSON() ([]byte, error) {
	type Alias DisassociateStoresRequest
	a := &struct {
		ProductCouponId *string `json:"product_coupon_id,omitempty"`
		StockId         *string `json:"stock_id,omitempty"`
		*Alias
