---
url: "https://pay.weixin.qq.com/doc/brand/4015736403-java.md"
title: "确认发放用户商品券-请求示例-java"
doc_id: 4015736403
example_lang: "java"
---
 ...
 * 确认发放用户商品券
 */
public class ConfirmSendUserProductCoupon {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/confirm";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/brand/4015415289
    ConfirmSendUserProductCoupon client = new ConfirmSendUserProductCoupon(
    ...
    ConfirmSendUserProductCouponRequest request = new ConfirmSendUserProductCouponRequest();
    ...
    request.outRequestNo = "MCHCONFIRM202003101234";
    try {
  ...
  public UserProductCouponEntity run(ConfirmSendUserProductCouponRequest request) {
    String uri = PATH;
  ...
  public ConfirmSendUserProductCoupon(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
  ...
  public static class ConfirmSendUserProductCouponRequest {
