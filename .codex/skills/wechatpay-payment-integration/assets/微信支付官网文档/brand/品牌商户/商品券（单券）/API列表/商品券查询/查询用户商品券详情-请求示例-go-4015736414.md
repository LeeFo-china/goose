---
url: "https://pay.weixin.qq.com/doc/brand/4015736414-go.md"
title: "查询用户商品券详情-请求示例-go"
doc_id: 4015736414
example_lang: "go"
---
...
func GetUserProductCoupon(config *wxpay_brand_utility.BrandConfig, request *GetUserProductCouponRequest) (response *UserProductCouponEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "GET"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}"
	)
