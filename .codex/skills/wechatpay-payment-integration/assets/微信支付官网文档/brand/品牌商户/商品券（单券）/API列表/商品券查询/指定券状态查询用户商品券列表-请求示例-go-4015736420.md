---
url: "https://pay.weixin.qq.com/doc/brand/4015736420-go.md"
...
func main() {
	...
	request := &ListUserProductCouponsRequest{
		...
		PageSize:        wxpay_brand_utility.Int64(10),
	}
...
func ListUserProductCoupons(config *wxpay_brand_utility.BrandConfig, request *ListUserProductCouponsRequest) (response *ListUserProductCouponsResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "GET"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupons"
	)
