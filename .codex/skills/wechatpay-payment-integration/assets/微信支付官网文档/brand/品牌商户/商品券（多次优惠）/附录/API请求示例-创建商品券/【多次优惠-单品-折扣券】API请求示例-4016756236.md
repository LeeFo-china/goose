---
url: "https://pay.weixin.qq.com/doc/brand/4016756236.md"
title: "【多次优惠-单品-折扣券】API请求示例"
doc_id: 4016756236
---
...
## 3. 多次优惠-单品-折扣券 (usage_mode=PROGRESSIVE_BUNDLE, scope=SINGLE, type=DISCOUNT)
...
curl -X POST \
  ...
  -d '{
    "out_request_no": "PROGRESSIVE_BUNDLE_SINGLE_DISCOUNT_20250101_003", # 必填，创建请求单号，品牌侧需保持唯一性，可使用数字、大小写字母、下划线_、短横线-组成，长度6-40字符
    ...
    "display_info": { # 必填，展示信息
      ...
      "original_price": 500, # 条件必填，当scope=SINGLE时必填，商品原价，单位：分
    ...
    "out_product_no": "Product_ProgressiveBundle_003", # 选填，外部商品ID

    "stock_bundle": { # 当usage_mode=PROGRESSIVE_BUNDLE时必填，批次组信息
      "remark": "单品折扣券批次", # 选填，备注
      ...
      "progressive_bundle_usage_rule": { # 当usage_mode=PROGRESSIVE_BUNDLE时必填，多次优惠使用规则
        ...
        "discount_coupon_list": [ # 当type=DISCOUNT时必填，折扣券规则列表，数量必须等于count（最少3个，最多15个）
          { "threshold": 0, "percent_off": 10 }, # 第1次：9折（threshold=0表示无门槛，percent_off最小1，最大99）
          { "threshold": 0, "percent_off": 15 }, # 第2次：8.5折
          { "threshold": 0, "percent_off": 20 }, # 第3次：8折
          { "threshold": 0, "percent_off": 25 }, # 第4次：7.5折
          { "threshold": 0, "percent_off": 30 }  # 第5次：7折
        ]
      },
      ...
      "usage_rule_display_info": { # 必填，使用规则展示信息
        ...
        "usage_description": "指定商品可用，多次递增优惠", # 必填，使用说明
 ...
 */
public class SingleDiscountSequentialJava {
  ...
  public static void main(String[] args) {
    ...
    SingleDiscountSequentialJava client = new SingleDiscountSequentialJava(
    ...
    request.outRequestNo = "PROGRESSIVE_BUNDLE_SINGLE_DISCOUNT_20250101_003"; // 必填，创建请求单号，6-40个字符
    ...
    request.displayInfo.name = "单品折扣券-可乐5次优惠"; // 必填，商品券名称，最多12个字符
    ...
    request.displayInfo.originalPrice = 500L; // 必填(单品券)，商品原价(单位：分)
    ...
    request.outProductNo = "Product_ProgressiveBundle_003"; // 选填，商户侧商品券唯一标识
    // 必填，批次信息
    request.stockBundle = new StockForCreate();
    request.stockBundle.remark = "单品折扣券批次"; // 选填，批次备注，最多60个字符
    ...
    request.stockBundle.usageRuleDisplayInfo.usageDescription = "指定商品可用，多次递增优惠"; // 选填，使用说明
  ...
  public SingleDiscountSequentialJava(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
