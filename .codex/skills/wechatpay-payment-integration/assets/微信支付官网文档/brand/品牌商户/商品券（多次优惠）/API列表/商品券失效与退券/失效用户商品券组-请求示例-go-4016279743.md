---
url: "https://pay.weixin.qq.com/doc/brand/4016279743-go.md"
...
func main() {
	...
	request := &DeactivateUserProductCouponBundleRequest{
		UserCouponBundleId: wxpay_brand_utility.String("123446565767"),
		Openid:             wxpay_brand_utility.String("oh-394z-6CGkNoJrsDLTTUKiAnp4"),
		ProductCouponId:    wxpay_brand_utility.String("1002323"),
		StockBundleId:      wxpay_brand_utility.String("100232301"),
		Appid:              wxpay_brand_utility.String("wx233544546545989"),
		OutRequestNo:       wxpay_brand_utility.String("1002600620019090123144054436"),
		DeactivateReason:   wxpay_brand_utility.String("商品已下线，使用户商品券失效"),
	}
...
func DeactivateUserProductCouponBundle(config *wxpay_brand_utility.BrandConfig, request *DeactivateUserProductCouponBundleRequest) (response *DeactivateUserProductCouponBundleResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupon-bundles/{user_coupon_bundle_id}/deactivate"
	)
