---
url: "https://pay.weixin.qq.com/doc/brand/4016279745-go.md"
...
func main() {
	...
	request := &SendUserProductCouponBundleRequest{
		ProductCouponId: wxpay_brand_utility.String("1000000014"),
		StockBundleId:   wxpay_brand_utility.String("712315129419284901"),
		Appid:           wxpay_brand_utility.String("wx233544546545989"),
		Openid:          wxpay_brand_utility.String("oh-394z-6CGkNoJrsDLTTUKiAnp4"),
		SendRequestNo:   wxpay_brand_utility.String("MCHCONFIRM202003101234"),
	}
...
func SendUserProductCouponBundle(config *wxpay_brand_utility.BrandConfig, request *SendUserProductCouponBundleRequest) (response *SendUserProductCouponBundleResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupon-bundles"
	)
