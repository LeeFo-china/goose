---
url: "https://pay.weixin.qq.com/doc/brand/4016427459-java.md"
title: "查询商品券批次列表-请求示例-java"
doc_id: 4016427459
example_lang: "java"
---
...
public class ListStocks {
  ...
  public ListStocksResponse run(ListStocksRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, ListStocksResponse.class);
      } else {
  ...
  public ListStocks(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
