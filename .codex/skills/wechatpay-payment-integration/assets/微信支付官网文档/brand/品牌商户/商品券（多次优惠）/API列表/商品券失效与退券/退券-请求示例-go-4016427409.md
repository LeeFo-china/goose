---
url: "https://pay.weixin.qq.com/doc/brand/4016427409-go.md"
title: "退券-请求示例-go"
doc_id: 4016427409
example_lang: "go"
---
...
func main() {
	...
	request := &ReturnUserProductCouponRequest{
		...
		OutRequestNo:    wxpay_brand_utility.String("MCHRETURN202003101234"),
	}
...
func ReturnUserProductCoupon(config *wxpay_brand_utility.BrandConfig, request *ReturnUserProductCouponRequest) (response *UserProductCouponEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/return"
	)
