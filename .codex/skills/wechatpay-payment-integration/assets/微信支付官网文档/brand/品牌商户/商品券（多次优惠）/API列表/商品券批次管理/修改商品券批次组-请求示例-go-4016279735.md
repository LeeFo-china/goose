---
url: "https://pay.weixin.qq.com/doc/brand/4016279735-go.md"
title: "修改商品券批次组-请求示例-go"
doc_id: 4016279735
example_lang: "go"
---
...
func main() {
	...
	request := &UpdateStockBundleRequest{
		...
		Remark:          wxpay_brand_utility.String("疯狂星期四项目专用"),
		UsageRuleDisplayInfo: &UsageRuleDisplayInfo{
			...
			PasscodeLink: wxpay_brand_utility.String("passcode_link.example"),
		},
...
func UpdateStockBundle(config *wxpay_brand_utility.BrandConfig, request *UpdateStockBundleRequest) (response *StockBundleEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "PATCH"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}"
	)
