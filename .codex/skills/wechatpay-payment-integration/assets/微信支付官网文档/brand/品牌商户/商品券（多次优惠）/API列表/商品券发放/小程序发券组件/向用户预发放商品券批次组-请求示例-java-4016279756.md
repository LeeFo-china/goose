---
url: "https://pay.weixin.qq.com/doc/brand/4016279756-java.md"
...
public class PreSendUserProductCouponBundle {
  ...
  private static String PATH = "/brand/marketing/product-coupon/users/{openid}/pre-send-coupon-bundle";
  ...
  public PreSendUserProductCouponBundleResponse run(PreSendUserProductCouponBundleRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, PreSendUserProductCouponBundleResponse.class);
      } else {
  ...
  public PreSendUserProductCouponBundle(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
