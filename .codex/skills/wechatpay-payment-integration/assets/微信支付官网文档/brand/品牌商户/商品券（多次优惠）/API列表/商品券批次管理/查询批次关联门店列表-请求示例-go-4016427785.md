---
url: "https://pay.weixin.qq.com/doc/brand/4016427785-go.md"
title: "查询批次关联门店列表-请求示例-go"
doc_id: 4016427785
example_lang: "go"
---
...
func main() {
	...
	request := &ListAssociatedStoresRequest{
		...
		PageSize:        wxpay_brand_utility.Int64(2),
	}
...
func ListAssociatedStores(config *wxpay_brand_utility.BrandConfig, request *ListAssociatedStoresRequest) (response *ListAssociatedStoresResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "GET"
		path   = "/brand/marketing/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/associated-stores"
	)
