---
url: "https://pay.weixin.qq.com/doc/brand/4016427398-java.md"
title: "核销用户商品券-请求示例-java"
doc_id: 4016427398
example_lang: "java"
---
 ...
 * 核销用户商品券
 */
public class UseUserProductCoupon {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/brand/marketing/product-coupon/users/{openid}/coupons/{coupon_code}/use";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/brand/4015415289
    UseUserProductCoupon client = new UseUserProductCoupon(
    ...
    UseUserProductCouponRequest request = new UseUserProductCouponRequest();
    ...
    request.useTime = "2025-08-03T12:00:00+08:00";
    request.outRequestNo = "MCHUSE202003101234";
    request.associatedOrderInfo = new UserProductCouponAssociatedOrderInfo();
    request.associatedOrderInfo.transactionId = "4200000000123456789123456789";
    try {
  ...
  public UserProductCouponEntity run(UseUserProductCouponRequest request) {
    String uri = PATH;
    uri = uri.replace("{coupon_code}", WXPayBrandUtility.urlEncode(request.couponCode));
  ...
  public UseUserProductCoupon(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
  ...
  public static class UseUserProductCouponRequest {
