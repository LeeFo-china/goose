---
url: "https://pay.weixin.qq.com/doc/brand/4016427368-go.md"
title: "创建商品券-请求示例-go"
doc_id: 4016427368
example_lang: "go"
---
...
func main() {
	...
	request := &CreateProductCouponRequest{
		...
		ProgressiveBundleUsageInfo: &ProgressiveBundleUsageInfo{
			Count:        wxpay_brand_utility.Int64(3),
			IntervalDays: wxpay_brand_utility.Int64(1),
		},
		// 展示信息
		DisplayInfo: &ProductCouponDisplayInfo{
			Name:          wxpay_brand_utility.String("全场多次折扣券"),
			ImageUrl:      wxpay_brand_utility.String("https://wxpaylogo.qpic.cn/wxpaylogo/xxxxx/xxx"),
			BackgroundUrl: wxpay_brand_utility.String("https://wxpaylogo.qpic.cn/wxpaylogo/xxxxx/xxx"),
			DetailImageUrlList: []string{
				"https://wxpaylogo.qpic.cn/wxpaylogo/xxxxx/xxx",
			},
		},
		OutProductNo: wxpay_brand_utility.String("Product_1234567890"),
		// 批次包信息（多次优惠使用 StockBundle）
		StockBundle: &StockBundleForCreate{
			Remark:         wxpay_brand_utility.String("8月工作日有效批次"),
			...
			ProgressiveBundleUsageRule: &StockBundleUsageRule{
				CouponAvailablePeriod: &CouponAvailablePeriod{
					AvailableBeginTime: wxpay_brand_utility.String("2025-08-01T00:00:00+08:00"),
					AvailableEndTime:   wxpay_brand_utility.String("2025-08-31T23:59:59+08:00"),
					AvailableDays:      wxpay_brand_utility.Int64(30),
				...
				DiscountCouponList: []DiscountCouponUsageRule{
					{
						...
						PercentOff: wxpay_brand_utility.Int64(50),
					},
					{
						Threshold:  wxpay_brand_utility.Int64(10000),
						PercentOff: wxpay_brand_utility.Int64(20),
					},
					{
						Threshold:  wxpay_brand_utility.Int64(10000),
			...
			UsageRuleDisplayInfo: &UsageRuleDisplayInfo{
				...
				UsageDescription: wxpay_brand_utility.String("工作日可用"),
				CouponAvailableStoreInfo: &CouponAvailableStoreInfo{
					Description:      wxpay_brand_utility.String("所有门店可用，可使用小程序查看门店列表"),
					MiniProgramAppid: wxpay_brand_utility.String("wx1234567890"),
