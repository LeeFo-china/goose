---
url: "https://pay.weixin.qq.com/doc/brand/4015582733-go.md"
...
func CreatePreAuthToken(config *wxpay_brand_utility.BrandConfig, request *CreatePreAuthTokenRequest) (response *PreAuthToken, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/card-member/pre-auth-tokens"
	)
