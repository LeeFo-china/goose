---
url: "https://pay.weixin.qq.com/doc/brand/4015582679-go.md"
...
func main() {
	...
	request := &CreateUserFeedsRequest{
		...
		OutRequestNo: wxpay_brand_utility.String("100002322019090134234sfdf"),
		Cell:         wxpay_brand_utility.String("15_1200_1"),
	}
...
func CreateUserFeeds(config *wxpay_brand_utility.BrandConfig, request *CreateUserFeedsRequest) (response *UserFeeds, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/card-member/user-feeds"
	)
