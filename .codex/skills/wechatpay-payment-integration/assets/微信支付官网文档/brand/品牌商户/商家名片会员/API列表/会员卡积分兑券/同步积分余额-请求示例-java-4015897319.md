---
url: "https://pay.weixin.qq.com/doc/brand/4015897319-java.md"
title: "同步积分余额-请求示例-java"
doc_id: 4015897319
example_lang: "java"
---
...
public class SyncUserPoint {
  ...
  private static String PATH = "/brand/card-member/user-points/sync";
  ...
  public UserPoint run(SyncUserPointRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, UserPoint.class);
      } else {
  ...
  public SyncUserPoint(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
