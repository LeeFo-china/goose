---
url: "https://pay.weixin.qq.com/doc/brand/4015582679-java.md"
...
public class CreateUserFeeds {
  ...
  private static String PATH = "/brand/card-member/user-feeds";
  ...
  public UserFeeds run(CreateUserFeedsRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, UserFeeds.class);
      } else {
  ...
  public CreateUserFeeds(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
