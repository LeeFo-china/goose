---
url: "https://pay.weixin.qq.com/doc/brand/4015897319-go.md"
title: "同步积分余额-请求示例-go"
doc_id: 4015897319
example_lang: "go"
---
...
func main() {
	...
	request := &SyncUserPointRequest{
		...
		PointBalance: wxpay_brand_utility.Int64(1000),
	}
...
func SyncUserPoint(config *wxpay_brand_utility.BrandConfig, request *SyncUserPointRequest) (response *UserPoint, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/card-member/user-points/sync"
	)
