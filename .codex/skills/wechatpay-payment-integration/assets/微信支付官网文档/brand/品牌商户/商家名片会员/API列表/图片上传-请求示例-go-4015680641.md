---
url: "https://pay.weixin.qq.com/doc/brand/4015680641-go.md"
title: "图片上传-请求示例-go"
doc_id: 4015680641
example_lang: "go"
---
...
func main() {
	...
	request := &UploadImageRequest{
		...
		Meta: &ImageMeta{
			Filename:   wxpay_brand_utility.String("file.jpg"),
			FileDigest: wxpay_brand_utility.String("hjkahkjsjkfsjk78687dhjahdajhk"),
		},
	}
...
func UploadImage(config *wxpay_brand_utility.BrandConfig, request *UploadImageRequest) (response *UploadImageResponse, err error) {
	const (
		...
		method = "POST"
		path   = "/brand/card-member/media/image-upload"
	)
