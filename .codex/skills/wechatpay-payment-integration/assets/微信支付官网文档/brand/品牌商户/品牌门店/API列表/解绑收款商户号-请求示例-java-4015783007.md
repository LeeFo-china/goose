---
url: "https://pay.weixin.qq.com/doc/brand/4015783007-java.md"
...
public class UnbindRecipient {
  ...
  private static String PATH = "/brand/store/brandstores/{store_id}/unbindrecipient";
  ...
  public BrandStoresUnbindRecipientResponse run(UnbindRecipientRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, BrandStoresUnbindRecipientResponse.class);
      } else {
  ...
  public UnbindRecipient(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
