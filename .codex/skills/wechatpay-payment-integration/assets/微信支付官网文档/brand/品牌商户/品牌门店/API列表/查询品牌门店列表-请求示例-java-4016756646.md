---
url: "https://pay.weixin.qq.com/doc/brand/4016756646-java.md"
...
public class ListBrandStores {
  ...
  private static String PATH = "/brand/store/brandstores";
  ...
  public BrandStoresListResponse run(ListBrandStoresRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, BrandStoresListResponse.class);
      } else {
  ...
  public ListBrandStores(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
