---
url: "https://pay.weixin.qq.com/doc/brand/4016756637-java.md"
...
public class CloseBrandStore {
  ...
  private static String PATH = "/brand/store/brandstores/{store_id}/close";
  ...
  public BrandStoresCloseResponse run(CloseBrandStoreRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, BrandStoresCloseResponse.class);
      } else {
  ...
  public CloseBrandStore(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
