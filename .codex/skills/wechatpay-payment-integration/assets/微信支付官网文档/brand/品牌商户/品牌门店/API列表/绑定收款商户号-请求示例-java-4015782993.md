---
url: "https://pay.weixin.qq.com/doc/brand/4015782993-java.md"
title: "绑定收款商户号-请求示例-java"
doc_id: 4015782993
example_lang: "java"
---
...
public class BindRecipient {
  ...
  private static String PATH = "/brand/store/brandstores/{store_id}/bindrecipient";
  ...
  public BrandStoresBindRecipientResponse run(BindRecipientRequest request) {
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, BrandStoresBindRecipientResponse.class);
      } else {
  ...
  public BindRecipient(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
