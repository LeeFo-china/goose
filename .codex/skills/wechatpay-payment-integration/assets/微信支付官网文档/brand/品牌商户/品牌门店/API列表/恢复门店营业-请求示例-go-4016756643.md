---
url: "https://pay.weixin.qq.com/doc/brand/4016756643-go.md"
...
func ResumeBrandStore(config *wxpay_brand_utility.BrandConfig, request *ResumeBrandStoreRequest) (response *BrandStoresResumeResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/store/brandstores/{store_id}/resume"
	)
