---
url: "https://pay.weixin.qq.com/doc/brand/4018381201-go.md"
...
func TerminateDeliveryPlan(config *wxpay_brand_utility.BrandConfig, request *TerminateDeliveryPlanRequest) (err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/delivery-plan/delivery-plans/{plan_id}/terminate"
	)
