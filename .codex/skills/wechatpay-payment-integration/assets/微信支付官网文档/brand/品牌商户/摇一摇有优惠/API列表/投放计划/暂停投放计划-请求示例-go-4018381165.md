---
url: "https://pay.weixin.qq.com/doc/brand/4018381165-go.md"
title: "暂停投放计划-请求示例-go"
doc_id: 4018381165
example_lang: "go"
---
...
func main() {
	...
	request := &PauseDeliveryPlanRequest{
		PlanId: wxpay_brand_utility.String("12000"),
	}

	err = PauseDeliveryPlan(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func PauseDeliveryPlan(config *wxpay_brand_utility.BrandConfig, request *PauseDeliveryPlanRequest) (err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/delivery-plan/delivery-plans/{plan_id}/pause"
	)
...
type PauseDeliveryPlanRequest struct {
	PlanId *string `json:"plan_id,omitempty"`
}

func (o *PauseDeliveryPlanRequest) MarshalJSON() ([]byte, error) {
	type Alias PauseDeliveryPlanRequest
	a := &struct {
		PlanId *string `json:"plan_id,omitempty"`
		*Alias
	}{
