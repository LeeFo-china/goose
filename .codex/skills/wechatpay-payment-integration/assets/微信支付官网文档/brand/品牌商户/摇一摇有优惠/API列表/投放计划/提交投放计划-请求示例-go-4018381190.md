---
url: "https://pay.weixin.qq.com/doc/brand/4018381190-go.md"
title: "提交投放计划-请求示例-go"
doc_id: 4018381190
example_lang: "go"
---
...
func main() {
	...
	request := &SubmitDeliveryPlanRequest{
		PlanId: wxpay_brand_utility.String("12000"),
	}

	err = SubmitDeliveryPlan(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func SubmitDeliveryPlan(config *wxpay_brand_utility.BrandConfig, request *SubmitDeliveryPlanRequest) (err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/brand/marketing/delivery-plan/delivery-plans/{plan_id}/submit"
	)
...
type SubmitDeliveryPlanRequest struct {
	PlanId *string `json:"plan_id,omitempty"`
}

func (o *SubmitDeliveryPlanRequest) MarshalJSON() ([]byte, error) {
	type Alias SubmitDeliveryPlanRequest
	a := &struct {
		PlanId *string `json:"plan_id,omitempty"`
		*Alias
	}{
