---
url: "https://pay.weixin.qq.com/doc/brand/4018381183-java.md"
title: "设置投放计划回调地址-请求示例-java"
doc_id: 4018381183
example_lang: "java"
---
...
public class SetCallbackUrl {
  ...
  private static String PATH = "/brand/marketing/delivery-plan/notify-url";
  ...
  public static void main(String[] args) {
    ...
    SetNotifyUrlRequest request = new SetNotifyUrlRequest();
  ...
  public SetNotifyUrlResponse run(SetNotifyUrlRequest request) {
    String uri = PATH;
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayBrandUtility.fromJson(respBody, SetNotifyUrlResponse.class);
      } else {
  ...
  public SetCallbackUrl(String brand_id, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
  ...
  public static class SetNotifyUrlRequest {
