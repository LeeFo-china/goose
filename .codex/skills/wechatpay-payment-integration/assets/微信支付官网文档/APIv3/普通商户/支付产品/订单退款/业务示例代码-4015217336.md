---
url: "https://pay.weixin.qq.com/doc/v3/merchant/4015217336.md"
title: "业务示例代码"
doc_id: 4015217336
---
...
- 可以通过[发起退款](https://pay.weixin.qq.com/doc/v3/merchant/4013071036.md)

- 可以通过[查询退款结果](https://pay.weixin.qq.com/doc/v3/merchant/4013071041.md)

- 如果退款异常时，可以通过[发起异常退款](https://pay.weixin.qq.com/doc/v3/merchant/4013071193.md)
...
```
package com.java.refund;

import com.java.demo.Create; // 使用商户平台申请退款接口：https://pay.weixin.qq.com/doc/v3/merchant/4013071036
...
public class CreateRefundDemo {
  ...
  public static void main(String[] args) {
    ...
    // 2.
    // 对于老资金流商户（老资金流也叫旧资金流，旧资金流如何区分见：https://kf.qq.com/faq/161223N7fi2E161223EvY3Ir.html）
    // - 不填写表示未结退款，从未结账户出资退款
...
import com.java.demo.Create; // 使用商户平台申请退款接口：https://pay.weixin.qq.com/doc/v3/merchant/4013071036
import static com.java.demo.Create.*;
import com.java.demo.QueryByOutRefundNo; // 使用商户平台查询单笔退款（按商户退款单号）接口，见：https://pay.weixin.qq.com/doc/v3/merchant/4013071041
import static com.java.demo.QueryByOutRefundNo.*;
import com.java.demo.CreateAbnormalRefund; // 使用商户平台发起异常退款接口，见：https://pay.weixin.qq.com/doc/v3/merchant/4013071193
...
public class QueryRefundDemo {
  ...
  public static void main(String[] args) {
    ...
    QueryByOutRefundNo.Refund refund;
    try {
      refund = client.run(request);
      ...
      if (e.getErrorCode().equals("RESOURCE_NOT_EXISTS")) {
        ...
        // 错误：无退款权限
        // 处理逻辑：检查商户是否是被处罚：登录商户平台进入账户中心-违约记录查询是否违约记录，如果有按照上面的指引解决违约记录之后原单重试
      } else if (e.getErrorCode().equals("SIGN_ERROR")) {
        // 错误：签名错误
