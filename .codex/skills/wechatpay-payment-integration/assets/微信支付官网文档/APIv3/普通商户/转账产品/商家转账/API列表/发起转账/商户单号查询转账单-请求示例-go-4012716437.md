---
url: "https://pay.weixin.qq.com/doc/v3/merchant/4012716437-go.md"
title: "商户单号查询转账单-请求示例-go"
doc_id: 4012716437
example_lang: "go"
---
...
func main() {
	...
	request := &GetTransferBillByOutNoRequest{
		OutBillNo: wxpay_utility.String("plfk2020042013"),
	}

	response, err := GetTransferBillByOutNo(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func GetTransferBillByOutNo(config *wxpay_utility.MchConfig, request *GetTransferBillByOutNoRequest) (response *TransferBillEntity, err error) {
	const (
