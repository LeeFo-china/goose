---
url: "https://pay.weixin.qq.com/doc/v3/merchant/4014399371-java.md"
title: "用户授权后转账-请求示例-java"
doc_id: 4014399371
example_lang: "java"
---
...
public class Transfer {
  ...
  private static String PATH = "/v3/fund-app/mch-transfer/transfer-bills/transfer";
  ...
  public static void main(String[] args) {
    ...
    request.authorizationId = "201202504101000123456789012";
  ...
  public TransferBillEntity run(TransferToUserRequest request) {
    String uri = PATH;
  ...
  public Transfer(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
