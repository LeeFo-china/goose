---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012476911-go.md"
title: "查询单笔退款（按商户退款单号）-请求示例-go"
doc_id: 4012476911
example_lang: "go"
---
...
func QueryRefundByOutRefundNo(config *wxpay_utility.MchConfig, request *QueryRefundByOutRefundNoRequest) (response *Refund, err error) {
	const (
...
func (o *QueryRefundByOutRefundNoRequest) MarshalJSON() ([]byte, error) {
	type Alias QueryRefundByOutRefundNoRequest
	a := &struct {
		OutRefundNo      *string `json:"out_refund_no,omitempty"`
		SubMchid         *string `json:"sub_mchid,omitempty"`
		*Alias
