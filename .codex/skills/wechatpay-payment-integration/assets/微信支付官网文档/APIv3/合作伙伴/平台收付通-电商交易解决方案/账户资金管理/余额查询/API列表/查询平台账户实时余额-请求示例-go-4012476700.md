---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012476700-go.md"
title: "查询平台账户实时余额-请求示例-go"
doc_id: 4012476700
example_lang: "go"
---
...
func main() {
	...
	response, err := QueryBalance(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func QueryBalance(config *wxpay_utility.MchConfig, request *QueryBalanceRequest) (response *Balance, err error) {
	const (
...
func (o *QueryBalanceRequest) MarshalJSON() ([]byte, error) {
	type Alias QueryBalanceRequest
	a := &struct {
		AccountType *AccountType `json:"account_type,omitempty"`
		*Alias
	}{
