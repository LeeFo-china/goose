---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012476670-go.md"
title: "平台预约提现-请求示例-go"
doc_id: 4012476670
example_lang: "go"
---
...
func main() {
	...
	response, err := CreateWithdraw(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func CreateWithdraw(config *wxpay_utility.MchConfig, request *CreateWithdrawRequest) (response *CreateWithdrawResponse, err error) {
	const (
	...
	if httpResponse.StatusCode >= 200 && httpResponse.StatusCode < 300 {
		...
		response := &CreateWithdrawResponse{}
