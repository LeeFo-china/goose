---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280633-go.md"
...
func UpdateStockBundle(config *wxpay_utility.MchConfig, request *UpdateStockBundleRequest) (response *StockBundleEntity, err error) {
	const (
