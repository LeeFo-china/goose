---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781608-java.md"
...
public class UseUserProductCoupon {
  ...
  private static String PATH = "/v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/use";
  ...
  public UseUserProductCoupon(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
