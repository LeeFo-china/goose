---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280622-java.md"
title: "添加商品券批次组-请求示例-java"
doc_id: 4016280622
example_lang: "java"
---
...
public class CreateStockBundle {
  ...
  private static String PATH = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles";
  ...
  public static void main(String[] args) {
    ...
    request.stockBundle.progressiveBundleUsageRule.couponAvailablePeriod.availableSeconds = 3600L;
    ...
    request.stockBundle.usageRuleDisplayInfo.appJumpType = AppJumpType.H5;
    request.stockBundle.usageRuleDisplayInfo.passcodeLink = "passcode_link.example";
  ...
  public CreateStockBundle(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
