---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781561-go.md"
title: "修改商品券批次发放预算-请求示例-go"
doc_id: 4015781561
example_lang: "go"
---
...
func main() {
	...
	request := &UpdateStockBudgetRequest{
		OutRequestNo:    wxpay_utility.String("update_budget_34657_20250101_123456"),
		...
		CurrentMaxCount: wxpay_utility.Int64(10000000),
		TargetMaxCount:  wxpay_utility.Int64(200),
		BrandId:         wxpay_utility.String("120344"),
	}

	response, err := UpdateStockBudget(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func UpdateStockBudget(config *wxpay_utility.MchConfig, request *UpdateStockBudgetRequest) (response *StockEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/update-budget"
	)
...
func (o *UpdateStockBudgetRequest) MarshalJSON() ([]byte, error) {
	type Alias UpdateStockBudgetRequest
	a := &struct {
		ProductCouponId *string `json:"product_coupon_id,omitempty"`
		StockId         *string `json:"stock_id,omitempty"`
		*Alias
...
func (e UpdateBudgetMode) Ptr() *UpdateBudgetMode {
	return &e
}
