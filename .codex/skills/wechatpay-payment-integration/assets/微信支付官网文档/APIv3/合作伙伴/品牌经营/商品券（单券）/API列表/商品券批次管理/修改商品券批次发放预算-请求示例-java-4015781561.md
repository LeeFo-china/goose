---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781561-java.md"
title: "修改商品券批次发放预算-请求示例-java"
doc_id: 4015781561
example_lang: "java"
---
 ...
 * 修改商品券批次发放预算
 */
public class UpdateStockBudget {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/update-budget";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/partner/4013080340
    UpdateStockBudget client = new UpdateStockBudget(
    ...
    UpdateStockBudgetRequest request = new UpdateStockBudgetRequest();
    request.outRequestNo = "update_budget_34657_20250101_123456";
    request.productCouponId = "1000000013";
    request.stockId = "1000000013001";
    request.updateMode = UpdateBudgetMode.MAX_COUNT;
    request.currentMaxCount = 10000000L;
    request.targetMaxCount = 200L;
  ...
  public StockEntity run(UpdateStockBudgetRequest request) {
    String uri = PATH;
  ...
  public UpdateStockBudget(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class UpdateStockBudgetRequest {
