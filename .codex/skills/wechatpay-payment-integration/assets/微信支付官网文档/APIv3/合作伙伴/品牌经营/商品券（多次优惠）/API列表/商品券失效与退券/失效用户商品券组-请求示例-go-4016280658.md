---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280658-go.md"
title: "失效用户商品券组-请求示例-go"
doc_id: 4016280658
example_lang: "go"
---
...
func main() {
	...
	request := &DeactivateUserProductCouponBundleRequest{
		UserCouponBundleId: wxpay_utility.String("123446565767"),
		Openid:             wxpay_utility.String("oh-394z-6CGkNoJrsDLTTUKiAnp4"),
		ProductCouponId:    wxpay_utility.String("1002323"),
		StockBundleId:      wxpay_utility.String("100232301"),
		Appid:              wxpay_utility.String("wx233544546545989"),
		OutRequestNo:       wxpay_utility.String("1002600620019090123144054436"),
		DeactivateReason:   wxpay_utility.String("商品已下线，使用户商品券失效"),
		BrandId:            wxpay_utility.String("120344"),
	}

	response, err := DeactivateUserProductCouponBundle(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func DeactivateUserProductCouponBundle(config *wxpay_utility.MchConfig, request *DeactivateUserProductCouponBundleRequest) (response *DeactivateUserProductCouponBundleResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/v3/marketing/partner/product-coupon/users/{openid}/coupon-bundles/{user_coupon_bundle_id}/deactivate"
	)
	...
	reqUrl.Path = strings.Replace(reqUrl.Path, "{user_coupon_bundle_id}", url.PathEscape(*request.UserCouponBundleId), -1)
	...
	if httpResponse.StatusCode >= 200 && httpResponse.StatusCode < 300 {
		...
		response := &DeactivateUserProductCouponBundleResponse{}
...
type DeactivateUserProductCouponBundleRequest struct {
...
func (o *DeactivateUserProductCouponBundleRequest) MarshalJSON() ([]byte, error) {
	type Alias DeactivateUserProductCouponBundleRequest
	a := &struct {
		UserCouponBundleId *string `json:"user_coupon_bundle_id,omitempty"`
		Openid             *string `json:"openid,omitempty"`
		*Alias
...
type DeactivateUserProductCouponBundleResponse struct {
	UserCouponBundleId    *string                   `json:"user_coupon_bundle_id,omitempty"`
	UserProductCouponList []UserProductCouponEntity `json:"user_product_coupon_list,omitempty"`
}
...
type UsageRuleDisplayInfo struct {
	...
	AppJumpType              *AppJumpType              `json:"app_jump_type,omitempty"`
	PasscodeLink             *string                   `json:"passcode_link,omitempty"`
}
...
type CouponAvailablePeriod struct {
	...
	AvailableSeconds             *int64           `json:"available_seconds,omitempty"`
}
...
type AppJumpType string

func (e AppJumpType) Ptr() *AppJumpType {
	return &e
}

const (
	APPJUMPTYPE_H5            AppJumpType = "H5"
	APPJUMPTYPE_PASSCODE_LINK AppJumpType = "PASSCODE_LINK"
	APPJUMPTYPE_USAGE_GUIDE   AppJumpType = "USAGE_GUIDE"
)
