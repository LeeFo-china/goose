---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781302-java.md"
title: "批次关联门店-请求示例-java"
doc_id: 4015781302
example_lang: "java"
---
 ...
 * 批次关联门店
 */
public class AssociateStores {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}/associate-stores";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/partner/4013080340
    AssociateStores client = new AssociateStores(
    ...
    AssociateStoresRequest request = new AssociateStoresRequest();
  ...
  public AssociateStoresResponse run(AssociateStoresRequest request) {
    String uri = PATH;
  ...
  public AssociateStores(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class AssociateStoresRequest {
