---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781590-go.md"
title: "指定券状态查询用户商品券列表-请求示例-go"
doc_id: 4015781590
example_lang: "go"
---
...
func main() {
	...
	request := &ListUserProductCouponsRequest{
	...
	response, err := ListUserProductCoupons(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func ListUserProductCoupons(config *wxpay_utility.MchConfig, request *ListUserProductCouponsRequest) (response *ListUserProductCouponsResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "GET"
		path   = "/v3/marketing/partner/product-coupon/users/{openid}/coupons"
	)
	...
	if request.CouponState != nil {
		query.Add("coupon_state", fmt.Sprintf("%v", *request.CouponState))
	}
	if request.UserCouponBundleId != nil {
		query.Add("user_coupon_bundle_id", *request.UserCouponBundleId)
	}
	...
	if httpResponse.StatusCode >= 200 && httpResponse.StatusCode < 300 {
		...
		response := &ListUserProductCouponsResponse{}
...
type ListUserProductCouponsRequest struct {
...
func (o *ListUserProductCouponsRequest) MarshalJSON() ([]byte, error) {
...
type ListUserProductCouponsResponse struct {
	TotalCount     *int64                    `json:"total_count,omitempty"`
	UserCouponList []UserProductCouponEntity `json:"user_coupon_list,omitempty"`
