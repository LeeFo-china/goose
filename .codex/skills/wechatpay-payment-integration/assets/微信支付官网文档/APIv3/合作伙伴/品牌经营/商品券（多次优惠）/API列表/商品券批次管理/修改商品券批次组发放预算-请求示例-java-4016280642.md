---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280642-java.md"
title: "修改商品券批次组发放预算-请求示例-java"
doc_id: 4016280642
example_lang: "java"
---
 ...
 * 修改商品券批次组发放预算
 */
public class UpdateStockBundleBudget {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}/update-budget";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/partner/4013080340
    UpdateStockBundleBudget client = new UpdateStockBundleBudget(
    ...
    UpdateStockBundleBudgetRequest request = new UpdateStockBundleBudgetRequest();
    request.productCouponId = "200000001";
    request.stockBundleId = "123456789";
    request.outRequestNo = "BUDGET1212512514";
    request.updateMode = UpdateBudgetMode.MAX_COUNT;
    request.currentMaxCount = 1L;
    request.targetMaxCount = 1L;
    request.currentMaxCountPerDay = 1L;
    request.targetMaxCountPerDay = 1L;
  ...
  public StockBundleEntity run(UpdateStockBundleBudgetRequest request) {
    String uri = PATH;
  ...
  public UpdateStockBundleBudget(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class UpdateStockBundleBudgetRequest {
    ...
    public UpdateBudgetMode updateMode;

    @SerializedName("current_max_count")
    public Long currentMaxCount;

    @SerializedName("target_max_count")
    public Long targetMaxCount;

    @SerializedName("current_max_count_per_day")
    public Long currentMaxCountPerDay;

    @SerializedName("target_max_count_per_day")
    public Long targetMaxCountPerDay;
