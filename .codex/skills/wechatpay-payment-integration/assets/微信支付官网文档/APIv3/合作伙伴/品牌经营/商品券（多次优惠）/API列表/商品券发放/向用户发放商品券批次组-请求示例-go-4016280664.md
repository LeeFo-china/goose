---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280664-go.md"
title: "向用户发放商品券批次组-请求示例-go"
doc_id: 4016280664
example_lang: "go"
---
...
func main() {
	...
	request := &SendUserProductCouponBundleRequest{
		ProductCouponId: wxpay_utility.String("1000000014"),
		StockBundleId:   wxpay_utility.String("712315129419284901"),
		Appid:           wxpay_utility.String("wx233544546545989"),
		Openid:          wxpay_utility.String("oh-394z-6CGkNoJrsDLTTUKiAnp4"),
		SendRequestNo:   wxpay_utility.String("MCHCONFIRM202003101234"),
		BrandId:         wxpay_utility.String("120344"),
	}

	response, err := SendUserProductCouponBundle(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func SendUserProductCouponBundle(config *wxpay_utility.MchConfig, request *SendUserProductCouponBundleRequest) (response *SendUserProductCouponBundleResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "POST"
		path   = "/v3/marketing/partner/product-coupon/users/{openid}/coupon-bundles"
	)
	...
	if httpResponse.StatusCode >= 200 && httpResponse.StatusCode < 300 {
		...
		response := &SendUserProductCouponBundleResponse{}
...
type SendUserProductCouponBundleRequest struct {
...
func (o *SendUserProductCouponBundleRequest) MarshalJSON() ([]byte, error) {
	type Alias SendUserProductCouponBundleRequest
	a := &struct {
		Openid *string `json:"openid,omitempty"`
		*Alias
	}{
...
type SendUserProductCouponBundleResponse struct {
