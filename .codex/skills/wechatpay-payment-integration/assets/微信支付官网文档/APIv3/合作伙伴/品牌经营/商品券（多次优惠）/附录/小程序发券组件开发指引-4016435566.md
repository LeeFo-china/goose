...
1. 完成“商品券”创建。商品券是微信支付品牌商家营销券体系，详细介绍可见：[创建商品券](https://pay.weixin.qq.com/doc/v3/partner/4016434630.md)
...
1. 发券：商户后端调用“[向用户预发放商品券批次组](https://pay.weixin.qq.com/doc/v3/partner/4016280670.md)”接口获取token后，在微信客户端前端页面调起“[调起小程序发券组件](https://pay.weixin.qq.com/doc/v3/partner/4016435568.md)”展示“待领取”页面。用户点击“立即领取”完成领券

2. 确认发券：用户领券后，微信支付会向商户发送“[商品券回调通知](https://pay.weixin.qq.com/doc/v3/partner/4016435717.md)”，商户接受通知后需调用“[确认发放用户商品券](https://pay.weixin.qq.com/doc/v3/partner/4016435562.md)”接口，确认发券成功。此时微信支付会将券状态从“待确认”扭转至“待生效”或“已生效”（取决于券可用时间）
