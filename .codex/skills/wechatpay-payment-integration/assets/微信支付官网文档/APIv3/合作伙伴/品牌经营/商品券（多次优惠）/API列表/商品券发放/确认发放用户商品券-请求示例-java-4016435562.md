---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016435562-java.md"
...
public class ConfirmSendUserProductCoupon {
  ...
  private static String PATH = "/v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/confirm";
  ...
  public ConfirmSendUserProductCoupon(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
