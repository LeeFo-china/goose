---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781578-java.md"
...
public class DeactivateUserProductCoupon {
  ...
  private static String PATH = "/v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate";
  ...
  public DeactivateUserProductCoupon(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
