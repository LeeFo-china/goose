---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781542-go.md"
title: "查询商品券指定批次-请求示例-go"
doc_id: 4015781542
example_lang: "go"
---
...
func main() {
	...
	response, err := GetStock(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func GetStock(config *wxpay_utility.MchConfig, request *GetStockRequest) (response *StockEntity, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "GET"
		path   = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stocks/{stock_id}"
	)
...
func (o *GetStockRequest) MarshalJSON() ([]byte, error) {
	type Alias GetStockRequest
	a := &struct {
		ProductCouponId *string `json:"product_coupon_id,omitempty"`
		StockId         *string `json:"stock_id,omitempty"`
		BrandId         *string `json:"brand_id,omitempty"`
