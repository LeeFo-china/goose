---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280633-java.md"
title: "修改商品券批次组-请求示例-java"
doc_id: 4016280633
example_lang: "java"
---
...
public class UpdateStockBundle {
  ...
  private static String PATH = "/v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}";
  ...
  public static void main(String[] args) {
    ...
    request.usageRuleDisplayInfo.appJumpType = AppJumpType.H5;
    request.usageRuleDisplayInfo.passcodeLink = "passcode_link.example";
  ...
  public UpdateStockBundle(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
