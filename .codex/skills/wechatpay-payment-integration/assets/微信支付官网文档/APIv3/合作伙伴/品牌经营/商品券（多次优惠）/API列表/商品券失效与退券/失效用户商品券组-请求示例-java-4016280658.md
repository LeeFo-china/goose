---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280658-java.md"
title: "失效用户商品券组-请求示例-java"
doc_id: 4016280658
example_lang: "java"
---
 ...
 * 失效用户商品券组
 */
public class DeactivateUserProductCouponBundle {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/v3/marketing/partner/product-coupon/users/{openid}/coupon-bundles/{user_coupon_bundle_id}/deactivate";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/partner/4013080340
    DeactivateUserProductCouponBundle client = new DeactivateUserProductCouponBundle(
    ...
    DeactivateUserProductCouponBundleRequest request = new DeactivateUserProductCouponBundleRequest();
    request.userCouponBundleId = "123446565767";
    request.openid = "oh-394z-6CGkNoJrsDLTTUKiAnp4";
    request.productCouponId = "1002323";
    request.stockBundleId = "100232301";
    request.appid = "wx233544546545989";
    request.outRequestNo = "1002600620019090123144054436";
    request.deactivateReason = "商品已下线，使用户商品券失效";
    request.brandId = "120344";
    try {
      DeactivateUserProductCouponBundleResponse response = client.run(request);
        // TODO: 请求成功，继续业务逻辑
  ...
  public DeactivateUserProductCouponBundleResponse run(DeactivateUserProductCouponBundleRequest request) {
    String uri = PATH;
    uri = uri.replace("{user_coupon_bundle_id}", WXPayUtility.urlEncode(request.userCouponBundleId));
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayUtility.fromJson(respBody, DeactivateUserProductCouponBundleResponse.class);
      } else {
  ...
  public DeactivateUserProductCouponBundle(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class DeactivateUserProductCouponBundleRequest {
  ...
  public static class DeactivateUserProductCouponBundleResponse {
    @SerializedName("user_coupon_bundle_id")
    public String userCouponBundleId;

    @SerializedName("user_product_coupon_list")
    public List<UserProductCouponEntity> userProductCouponList = new ArrayList<UserProductCouponEntity>();
  }
