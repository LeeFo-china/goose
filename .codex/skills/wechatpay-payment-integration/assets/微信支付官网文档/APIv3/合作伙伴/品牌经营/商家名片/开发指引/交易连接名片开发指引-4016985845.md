...
| 必须接入 | [撤销交易连接名片配置申请](https://pay.weixin.qq.com/doc/v3/partner/4016366797.md) | 服务商可调用该接口撤销交易连接名片申请。<br>注意：仅当申请状态为审核中、审核驳回、待商户号超管确认、商户号超管已拒绝时才允许撤销。<br>频率限制：接口级限制1/s<br>前置条件：已提交配置申请 |
| 必须接入 | [根据业务申请编号查询添加申请状态](https://pay.weixin.qq.com/doc/v3/partner/4016366816.md) | 服务商可调用此接口查询申请状态。<br>频率限制：接口级限制100/s<br>前置条件：已提交配置申请 |
| 按需接入 | [查询已生效交易连接名片规则](https://pay.weixin.qq.com/doc/v3/partner/4016366785.md) | 服务商可调用该接口查询品牌下所有已生效的交易连接名片规则列表。<br>频率限制：接口级限制1/s |
| 按需接入 | [解除已生效交易连接名片场景](https://pay.weixin.qq.com/doc/v3/partner/4016366804.md) | 服务商可调用该接口直接解除交易连接关系。<br>注意：解除配置成功的连接规则将在6小时内失效<br>频率限制：接口级限制1/s<br>前置条件：已配置连接规则 |