---
url: "https://pay.weixin.qq.com/doc/v3/partner/4016280664-java.md"
title: "向用户发放商品券批次组-请求示例-java"
doc_id: 4016280664
example_lang: "java"
---
 ...
 * 向用户发放商品券批次组
 */
public class SendUserProductCouponBundle {
  private static String HOST = "https://api.mch.weixin.qq.com";
  private static String METHOD = "POST";
  private static String PATH = "/v3/marketing/partner/product-coupon/users/{openid}/coupon-bundles";

  public static void main(String[] args) {
    // TODO: 请准备商户开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/partner/4013080340
    SendUserProductCouponBundle client = new SendUserProductCouponBundle(
    ...
    SendUserProductCouponBundleRequest request = new SendUserProductCouponBundleRequest();
    request.productCouponId = "1000000014";
    request.stockBundleId = "712315129419284901";
    request.appid = "wx233544546545989";
    request.openid = "oh-394z-6CGkNoJrsDLTTUKiAnp4";
    request.sendRequestNo = "MCHCONFIRM202003101234";
    request.brandId = "120344";
    try {
      SendUserProductCouponBundleResponse response = client.run(request);
        // TODO: 请求成功，继续业务逻辑
  ...
  public SendUserProductCouponBundleResponse run(SendUserProductCouponBundleRequest request) {
    String uri = PATH;
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayUtility.fromJson(respBody, SendUserProductCouponBundleResponse.class);
      } else {
  ...
  public SendUserProductCouponBundle(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class SendUserProductCouponBundleRequest {
  ...
  public static class SendUserProductCouponBundleResponse {
