---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781590-java.md"
title: "指定券状态查询用户商品券列表-请求示例-java"
doc_id: 4015781590
example_lang: "java"
---
 ...
 * 指定券状态查询用户商品券列表
 */
public class ListUserProductCoupons {
  ...
  public static void main(String[] args) {
    ...
    ListUserProductCoupons client = new ListUserProductCoupons(
    ...
    ListUserProductCouponsRequest request = new ListUserProductCouponsRequest();
    ...
    try {
      ListUserProductCouponsResponse response = client.run(request);
        // TODO: 请求成功，继续业务逻辑
  ...
  public ListUserProductCouponsResponse run(ListUserProductCouponsRequest request) {
    String uri = PATH;
    ...
    args.put("coupon_state", request.couponState);
    args.put("user_coupon_bundle_id", request.userCouponBundleId);
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayUtility.fromJson(respBody, ListUserProductCouponsResponse.class);
      } else {
  ...
  public ListUserProductCoupons(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class ListUserProductCouponsRequest {
  ...
  public static class ListUserProductCouponsResponse {
    @SerializedName("total_count")
    public Long totalCount;

    @SerializedName("user_coupon_list")
    public List<UserProductCouponEntity> userCouponList;
