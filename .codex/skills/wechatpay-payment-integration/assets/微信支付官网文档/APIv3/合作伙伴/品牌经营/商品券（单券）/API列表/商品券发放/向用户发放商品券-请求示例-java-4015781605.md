---
url: "https://pay.weixin.qq.com/doc/v3/partner/4015781605-java.md"
...
public class SendUserProductCoupon {
  ...
  private static String PATH = "/v3/marketing/partner/product-coupon/users/{openid}/coupons";
  ...
  public SendUserProductCoupon(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
