---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012471327-go.md"
title: "查询商户违规通知回调地址-请求示例-go"
doc_id: 4012471327
example_lang: "go"
---
...
func main() {
	...
	response, err := QueryViolationNotification(config)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func QueryViolationNotification(config *wxpay_utility.MchConfig) (response *ViolationNotification, err error) {
	const (
