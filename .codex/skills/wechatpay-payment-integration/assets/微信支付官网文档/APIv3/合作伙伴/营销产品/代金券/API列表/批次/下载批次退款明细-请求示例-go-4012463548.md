---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012463548-go.md"
title: "下载批次退款明细-请求示例-go"
doc_id: 4012463548
example_lang: "go"
---
...
func main() {
	...
	request := &RefundFlowRequest{
		StockId: wxpay_utility.String("9865000"),
	}

	response, err := RefundFlow(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func RefundFlow(config *wxpay_utility.MchConfig, request *RefundFlowRequest) (response *RefundFlowResponse, err error) {
	const (
		host   = "https://api.mch.weixin.qq.com"
		method = "GET"
		path   = "/v3/marketing/favor/stocks/{stock_id}/refund-flow"
	)
