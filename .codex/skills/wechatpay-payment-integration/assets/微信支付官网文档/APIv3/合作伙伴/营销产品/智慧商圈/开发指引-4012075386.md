...
智慧商圈接入前需先邮件申请接入权限，申请发放具体可查看[开发接入准备](https://pay.weixin.qq.com/doc/v3/partner/4012075231.md#%E6%99%BA%E6%85%A7%E5%95%86%E5%9C%88%E6%8E%A5%E5%85%A5%E6%B5%81%E7%A8%8B)，小程序插件可参考：[小程序插件开发文档](https://developers.weixin.qq.com/miniprogram/dev/framework/plugin/)

步骤10[商圈支付结果通知](https://pay.weixin.qq.com/doc/v3/partner/4012076414.md)（已开通积分功能的用户，在场内发生交易时，会将交易信息返回至开通时提交的回调地址）

步骤12[商圈积分同步](https://pay.weixin.qq.com/doc/v3/partner/4012474133.md)（只有接入该接口，才会获取到退款信息）

步骤13[商圈退款成功通知](https://pay.weixin.qq.com/doc/v3/partner/4012076419.md)（对已同步过积分的交易，监控30天内的退款情况，若发生退款，则会把相关退款通知发送给商圈商户，商户的回调地址同支付结果回调地址保持一致）
...
4. [商圈积分通知回调](https://pay.weixin.qq.com/doc/v3/partner/4012474133.md)（只有接入该接口，才会获取到退款信息）。

5. [商圈会员场内退款通知](https://pay.weixin.qq.com/doc/v3/partner/4012076419.md)（对已同步过积分的会员消费，监控30天内的退款情况，若发生退款，会将退款信息发送至开通时配置的用户消费回调地址）。

6. [商圈积分授权查询](https://pay.weixin.qq.com/doc/v3/partner/4012474135.md) （可通过此API查询已授权过商圈会员积分服务用户的最新授权状态）。

7. [查询商圈会员待积分状态](https://pay.weixin.qq.com/doc/v3/partner/4012474129.md)（可通过此API查询已授权商圈会员积分服务的用户当天是否有待积分的消费，并可在商圈小程序任意页面引导用户前往“商圈会员快速积分”插件提交积分申请）。

8. [更新商圈会员停车状态](https://pay.weixin.qq.com/doc/v3/partner/4012474127.md)（可通过此API同步会员停车到场状态给微信支付，对用会员的商场内门店消费可100%自动积分）。


更多参数、响应详情及错误码请参见 [商圈支付结果通知](https://pay.weixin.qq.com/doc/v3/partner/4012474133.md)API接口文档。
...
更多参数、响应详情及错误码请参见[商圈积分同步](https://pay.weixin.qq.com/doc/v3/partner/4012474133.md)接口文档。
...
- 按照接口文档进行API证书配置，[积分信息回调](https://pay.weixin.qq.com/doc/v3/partner/4012076414.md)接口文档， [API证书配置](https://pay.weixin.qq.com/doc/v3/partner/4012081992.md)
