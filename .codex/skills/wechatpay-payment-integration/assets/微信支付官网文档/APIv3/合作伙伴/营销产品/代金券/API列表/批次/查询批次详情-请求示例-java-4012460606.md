---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012460606-java.md"
title: "查询批次详情-请求示例-java"
doc_id: 4012460606
example_lang: "java"
---
...
public class QueryStock {
  ...
  private static String PATH = "/v3/marketing/favor/stocks/{stock_id}";
  ...
  public static void main(String[] args) {
    ...
    request.stockId = "9856888";
    request.stockCreatorMchid = "123456";
    try {
      Stock response = client.run(request);
        // TODO: 请求成功，继续业务逻辑
  ...
  public Stock run(QueryStockRequest request) {
    String uri = PATH;
    ...
    try (Response httpResponse = client.newCall(httpRequest).execute()) {
      ...
      if (httpResponse.code() >= 200 && httpResponse.code() < 300) {
        ...
        // 从HTTP应答报文构建返回数据
        return WXPayUtility.fromJson(respBody, Stock.class);
      } else {
  ...
  public QueryStock(String mchid, String certificateSerialNo, String privateKeyFilePath, String wechatPayPublicKeyId, String wechatPayPublicKeyFilePath) {
    this.mchid = mchid;
  ...
  public static class QueryStockRequest {
