---
url: "https://pay.weixin.qq.com/doc/v3/partner/4012460448-go.md"
title: "重启代金券批次-请求示例-go"
doc_id: 4012460448
example_lang: "go"
---
...
func main() {
	...
	request := &RestartStockRequest{
		StockId:           wxpay_utility.String("8965000"),
		StockCreatorMchid: wxpay_utility.String("9865000"),
	}

	response, err := RestartStock(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func RestartStock(config *wxpay_utility.MchConfig, request *RestartStockRequest) (response *RestartStockResponse, err error) {
	const (
...
func (o *RestartStockRequest) MarshalJSON() ([]byte, error) {
	type Alias RestartStockRequest
	a := &struct {
		StockId *string `json:"stock_id,omitempty"`
		*Alias
	}{
