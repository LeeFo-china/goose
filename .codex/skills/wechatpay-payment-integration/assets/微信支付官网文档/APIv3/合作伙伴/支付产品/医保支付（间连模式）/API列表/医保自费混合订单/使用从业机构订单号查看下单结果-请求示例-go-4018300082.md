---
url: "https://pay.weixin.qq.com/doc/v3/partner/4018300082-go.md"
title: "使用从业机构订单号查看下单结果-请求示例-go"
doc_id: 4018300082
example_lang: "go"
---
...
func main() {
	...
	response, err := QueryOrderByOutTradeNo(config, request)
	if err != nil {
		fmt.Printf("请求失败: %+v\n", err)
...
func QueryOrderByOutTradeNo(config *wxpay_utility.MchConfig, request *QueryOrderByOutTradeNoRequest) (response *OrderEntity, err error) {
	const (
...
func (o *QueryOrderByOutTradeNoRequest) MarshalJSON() ([]byte, error) {
	type Alias QueryOrderByOutTradeNoRequest
	a := &struct {
		OutTradeNo *string `json:"out_trade_no,omitempty"`
		SubMchid   *string `json:"sub_mchid,omitempty"`
		*Alias
