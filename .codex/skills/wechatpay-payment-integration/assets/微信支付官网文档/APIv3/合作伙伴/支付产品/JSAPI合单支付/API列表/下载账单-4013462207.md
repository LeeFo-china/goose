...
当商户调用[申请所有/单个子商户（也叫特约商户）交易账单](https://pay.weixin.qq.com/doc/v3/partner/4013080595.md)/[申请服务商资金账单](https://pay.weixin.qq.com/doc/v3/partner/4013080596.md)/接口，获取到下载账单链接download\_url后，需按照[V3接口规则生成签名](https://pay.weixin.qq.com/doc/v3/merchant/4012365337.md)，然后请求下载账单链接download\_url获取对应的账单文件。
