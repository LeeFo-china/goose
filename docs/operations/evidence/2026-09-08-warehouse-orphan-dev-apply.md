...
本地同步完成后，2026-09-08T07:05:20Z 对 C 候选 `01fd68a5` 再次执行 CLI migration list：Local 599／Remote 595，Remote-only 0，修复版本对齐，仅 `20260908015230`、`20260908015649`、`20260908020216`、`20260908023924` 待执行。[完整 599 行历史](2026-09-08-warehouse-stage-c-after-orphan-repair-history.json)。同步后 69 项相关测试及 API check 重新通过；本地保留两个分支，不删除工作区或临时备份。

后续更新（2026-09-08 15:24）：独立修复分支已推送，开发 API 发布及核验通过；main 未合并，C 未发布。以上“尚未 push／部署”是数据库应用轮次结束时的历史状态，最新证据见[清理脚本开发发布验收](2026-09-08-warehouse-orphan-cleanup-dev-release.md)。
