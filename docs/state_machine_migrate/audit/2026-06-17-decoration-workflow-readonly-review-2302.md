...
- `generated_at = 2026-06-17T15:02:39.042Z`
...
- `generated_at = 2026-06-17T15:02:38.743Z`
- `sample_size = 10`
...
| 类型 | 数量 | 处置状态 |
| --- | ---: | --- |
| 兼容继续推进 | 6 | 通过当前 workflow task 和后端 actions 继续推进 |
| 项目签约受控重建 | 1 | 需业务确认后执行 dry-run / apply |
| 关闭客户旧实例取消 | 2 | 需业务确认客户保持 `invalid` 后执行 dry-run / apply |
| 施工后段人工恢复点 | 1 | 项目 `634ff402-ff84-4541-aa7c-3cdcd4fd5460` 需人工决策 |
