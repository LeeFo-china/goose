...
| 默认租户 | 默认装修公司 |
| 平台超管手机号 | `19900000003` |
| 租户管理员手机号 | `19900000001`、`19900000002` |
...
```text
平台超管手机号：19900000003
平台超管角色：platform_admin
租户管理员手机号：19900000001
租户管理员角色：system_admin
...
2. 使用 `19900000003` 可登录平台超管后台。
3. 使用 `19900000001` 或 `19900000002` 可登录租户后台。
4. 租户管理员登录后租户为默认装修公司。
5. 平台超管登录后平台页可见平台超管入口。
6. 租户页、客户页、员工页、计费页等请求不误打生产 API。
7. 图片上传、预览、签名 URL 展示等文件能力正常。
