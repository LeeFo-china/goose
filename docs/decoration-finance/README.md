...
- [2026-06-29-phase7-4-manual-allocation-smoke.md](./2026-06-29-phase7-4-manual-allocation-smoke.md)：Phase 7.4 人工收款核销入口实施与 smoke 记录，包含静态验证、migration 阻塞原因和小程序边界。
