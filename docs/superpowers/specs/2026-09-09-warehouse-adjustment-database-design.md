...
实现提交 `4362ec06`：四个原子命令、仅定义权限和真实SQL夹具已交付；主线程独立13个SQL夹具、7组真实竞争及2负控、Domain25项/API57项、类型及构建检查通过。详细范围和审查状态见[数据库验证记录](../../operations/evidence/2026-09-09-warehouse-adjustment-database.md)。尚未远端apply或开放入口。
