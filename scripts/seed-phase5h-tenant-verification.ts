...
const fixture = {
  ...
  acceptanceItemA1: "5aaaaaaa-0101-4aaa-8aaa-aaaaaaaaaaaa",
  acceptanceItemA2: "5aaaaaaa-0102-4aaa-8aaa-aaaaaaaaaaaa",
  acceptanceItemA3: "5aaaaaaa-0103-4aaa-8aaa-aaaaaaaaaaaa",
  acceptanceItemA4: "5aaaaaaa-0104-4aaa-8aaa-aaaaaaaaaaaa",
  acceptanceItemB1: "5bbbbbbb-0101-4bbb-8bbb-bbbbbbbbbbbb",
  acceptanceItemB2: "5bbbbbbb-0102-4bbb-8bbb-bbbbbbbbbbbb",
  acceptanceItemB3: "5bbbbbbb-0103-4bbb-8bbb-bbbbbbbbbbbb",
  acceptanceItemB4: "5bbbbbbb-0104-4bbb-8bbb-bbbbbbbbbbbb",
...
async function seed() {
  ...
  await insert("project_acceptance_items", [
    {
      id: fixture.acceptanceItemA1,
      tenant_id: fixture.tenantA,
      acceptance_id: fixture.acceptanceA,
      category: "安全",
      title: "强弱电间距",
      standard: "强弱电管线保持合理间距，交叉处有保护处理",
      required: true,
    ...
    {
      id: fixture.acceptanceItemA2,
      tenant_id: fixture.tenantA,
      acceptance_id: fixture.acceptanceA,
      category: "工艺",
      title: "线管固定",
      standard: "管线固定牢靠，转弯顺畅，无明显破损",
      required: true,
      allow_not_applicable: false,
      photo_required: false,
      photo_min_count: 0,
    ...
    {
      id: fixture.acceptanceItemA4,
      tenant_id: fixture.tenantA,
      acceptance_id: fixture.acceptanceA,
      category: "材料",
      title: "材料品牌规格",
      standard: "材料品牌规格与合同或确认单一致",
      required: true,
      allow_not_applicable: false,
      photo_required: false,
      photo_min_count: 0,
    ...
    {
      id: fixture.acceptanceItemB1,
      tenant_id: fixture.tenantB,
      acceptance_id: fixture.acceptanceB,
      category: "安全",
      title: "强弱电间距",
      standard: "强弱电管线保持合理间距，交叉处有保护处理",
      required: true,
