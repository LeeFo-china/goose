...
function CampaignRewardFields({ form }: { form: UseFormReturn<CampaignFormValues> }) {
  return (
    <>
      <FieldGroup className="grid gap-4 md:grid-cols-2">
        <Field>
