import { BarChart3, Bot, Clapperboard, MessageSquareText, TriangleAlert } from "lucide-react";
    ...
    <div className="grid gap-3 md:grid-cols-5">
      ...
      <Card>
        <CardContent className="flex items-center gap-3 p-4">
          ...
          <div>
            <div className="text-sm text-muted-foreground">短视频转写</div>
            <div className="text-xl font-semibold">{formatNumber(data.social_video.billable_minutes)} 分钟</div>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="flex items-center gap-3 p-4">
          ...
          <div>
            ...
            <div className="text-xl font-semibold">
              {formatNumber(data.ai.failure_count + data.sms.failure_count + data.social_video.failure_count)}
            </div>
          </div>
        </CardContent>
      </Card>
