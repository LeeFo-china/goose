...
export type SupplierRolloutFlag = typeof SUPPLIER_ROLLOUT_FLAGS[number] | "warehouse_materials_enabled" | "warehouse_transfers_enabled" | "warehouse_stocktakes_enabled";
...
export function canToggleSupplierRolloutFlag(
  ...
  if (flag === "warehouse_materials_enabled" || flag === "warehouse_transfers_enabled" || flag === "warehouse_stocktakes_enabled") return true;
...
export function hasEnabledSupplierRolloutFlags(
  ...
  return settings.warehouse_materials_enabled === true || settings.warehouse_transfers_enabled === true ||
    settings.warehouse_stocktakes_enabled === true ||
    SUPPLIER_ROLLOUT_FLAGS.some((flag) => settings[flag]);
}
