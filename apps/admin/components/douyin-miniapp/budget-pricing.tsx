...
import {
  ...
  BUDGET_PRICING_PAGE_SIZE, addPricingEditorItem, buildPricingDraftPayload,
        ...
        <div className="flex min-w-0 flex-col gap-4">
          ...
          <Card className="shadow-none">
            ...
            <CardContent className="flex flex-col gap-2">
              ...
              {viewState === "ready" ? data.list.map((version) => <VersionButton key={version.id} version={version} isCurrent={version.id === activeVersion?.id} selected={version.id === selectedId} disabled={busy || (dirty && version.id !== selectedId)} onSelect={() => setSelectedId(version.id)} />) : null}
            </CardContent>
