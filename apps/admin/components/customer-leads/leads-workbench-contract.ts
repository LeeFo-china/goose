...
export type LeadDetail = LeadRow & LeadSourceProjection & {
  actions?: Record<"assign" | "follow_up" | "convert" | "mark_invalid", CustomerLeadActionAvailability>;
...
export const appointmentCommonShape = {
...
export function validPage<T>(value: { list: T[]; pagination: Pagination }, expected: {
