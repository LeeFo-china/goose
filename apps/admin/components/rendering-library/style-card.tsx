...
import { SOURCE_LABELS, SPACE_LABELS, STATUS_LABELS, STYLE_LABELS, hasUnpublishedChanges, publishActionLabel } from './contracts';
    ...
    <div className="flex min-w-0 flex-1 flex-col gap-3 p-3">
      ...
      <div className="mt-auto flex flex-wrap gap-1">
        {canManage ? <><Button size="sm" variant="outline" onClick={() => onEdit(style)}>编辑</Button>
          <Button size="sm" onClick={() => onCommand(style, 'publish')}>{publishActionLabel(style)}</Button>
