...
import {
  BrandingVirtualPaymentReconciliationRepository,
  type BrandingVirtualPaymentReconciliationClaim,
} from "./branding-virtual-payment-reconciliation";
...
export class BrandingVirtualOrderRepository
  extends BrandingVirtualPaymentReconciliationRepository {
  constructor(
