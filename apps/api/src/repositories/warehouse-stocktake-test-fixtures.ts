...
export const STOCKTAKE_TENANT_ID = '20000000-0000-4000-8000-000000000001';
export const STOCKTAKE_USER_ID = '30000000-0000-4000-8000-000000000001';
export const STOCKTAKE_EMPLOYEE_ID = '40000000-0000-4000-8000-000000000001';
export const STOCKTAKE_ACTOR = { tenant_id: STOCKTAKE_TENANT_ID, actor_user_id: STOCKTAKE_USER_ID,
  actor_employee_id: STOCKTAKE_EMPLOYEE_ID };
export const STOCKTAKE_ORDER = { id: STOCKTAKE_ID, tenant_id: STOCKTAKE_TENANT_ID, warehouse_id: STOCKTAKE_ID,
  order_no: 'WS-0000000001', status: 'draft' as const, version: 1, reason: '月末盘点',
  created_by_employee_id: STOCKTAKE_EMPLOYEE_ID, updated_by_employee_id: STOCKTAKE_EMPLOYEE_ID,
...
export function stocktakeAuth(permissions: string[]): AuthContext {
  return { authUserId: STOCKTAKE_USER_ID, employeeId: STOCKTAKE_EMPLOYEE_ID, tenantId: STOCKTAKE_TENANT_ID,
