...
const DetailRecordSchema = ListRecordSchema.extend({
  ...
  share_link_id: z.uuid().nullable(),
  referred_by_user_id: z.uuid().nullable(),
  referred_by_openid: NullableStringSchema,
  referred_by_employee_id: z.uuid().nullable(),
  referral_source: z.literal("tenant_onboarding_share").nullable(),
