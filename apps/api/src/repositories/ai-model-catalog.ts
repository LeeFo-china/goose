...
const ROUTE_SELECT = [
  ...
  "created_at",
  "updated_at",
  "primary_model:ai_models!ai_scene_routes_primary_model_id_fkey(id,provider_id,code,name,model_name,modality,status,provider:ai_providers!ai_models_provider_id_fkey(id,code,name,provider_type,status))",
  "fallback_model:ai_models!ai_scene_routes_fallback_model_id_fkey(id,provider_id,code,name,model_name,modality,status,provider:ai_providers!ai_models_provider_id_fkey(id,code,name,provider_type,status))",
].join(",");
