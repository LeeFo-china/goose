...
import PlatformOperatorsController from "@/controllers/platform-operators";
import PlatformAuthController from "@/controllers/platform-auth";
import PlatformRolesController from "@/controllers/platform-roles";
...
import BillingServiceTrialsController from "@/controllers/billing-service-trials";
...
import PlatformServicePromotionsController from "@/controllers/platform-service-promotions";
import PlatformServiceOrdersController from "@/controllers/platform-service-orders";
import PlatformServiceTrialsController from "@/controllers/platform-service-trials";
...
import TenantOwnerDailyDashboardController from "@/controllers/tenant-owner-daily-dashboard";
import PlatformDouyinMiniappsController from "@/controllers/platform-douyin-miniapps";
import PlatformCustomerRenderingSettingsController from "@/controllers/platform-customer-rendering-settings";
...
import PlatformAdminReviewWorkbenchController from "@/controllers/platform-admin-review-workbench";
...
const indexRoutes: FastifyPluginAsync = async (app, options) => {
  ...
  PlatformOperatorsController.registerExtraRoutes(app);
  PlatformAuthController.registerExtraRoutes(app);
  PlatformRolesController.registerExtraRoutes(app);
  ...
  BillingServiceTrialsController.registerExtraRoutes(app);
  ...
  PlatformServicePromotionsController.registerExtraRoutes(app);
  PlatformServiceOrdersController.registerExtraRoutes(app);
  PlatformServiceTrialsController.registerExtraRoutes(app);
  ...
  TenantDouyinMaterialNotesController.registerExtraRoutes(app);
  TenantOwnerDailyDashboardController.registerExtraRoutes(app);
  PlatformDouyinMiniappsController.registerExtraRoutes(app);
  PlatformCustomerRenderingSettingsController.registerExtraRoutes(app);
  ...
  SupplierPurchasableProductsController.registerExtraRoutes(app);
  SupplierPurchasableSkusController.registerExtraRoutes(app);
  ...
  SupplierPurchaseBatchesController.registerExtraRoutes(app);
  SupplierPayablesController.registerExtraRoutes(app);
  SupplierPaymentRequestsController.registerExtraRoutes(app);
  WarehousesController.registerExtraRoutes(app);
  InventoryController.registerExtraRoutes(app);
  ...
  PlatformAdminReviewWorkbenchController.registerExtraRoutes(app);
